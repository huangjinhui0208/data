...
class ImuSensor(Sensor):
    ...
    def __init__(
        ...
        self.frame_coordinator.register_imu_publisher(self.publish_imu_msg)
        self.listen()
    ...
    def sensor_data_updated(self, carla_imu_measurement):
        ...
        """
        frame_id = carla_imu_measurement.frame
        imu_msg = CorrectedImu()
        imu_msg.header.timestamp_sec = self.node.get_time(frame_id=frame_id)
        ...
        self.frame_coordinator.submit_imu(frame_id, imu_msg)

    def publish_imu_msg(self, imu_msg):
