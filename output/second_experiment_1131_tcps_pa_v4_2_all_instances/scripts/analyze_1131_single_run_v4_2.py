#!/usr/bin/env python3
"""TCPS-PA v4.2 base analysis for second-experiment run 202607271131.
...
def build() -> dict:
    ...
    # v4.2 time semantics: this source epoch is t_sample, not an implicit
    ...
    # Claims retain the validator-compatible C1-C7 IDs and add v4.2 gates.
...
```
"""
    # Replace the legacy-compatible narrative above with the v4.2 semantics.
...
"""
    ...
    (OUTPUT / "README.md").write_text(
        "# Run 202607271131 TCPS-PA v4.2 analysis\n\n"
