...
**SUPPORT:** EV.FAULT.1131 (DIRECT_OBSERVED), EV.FRESH.1131 (OBSERVED_DERIVED), EV.ALLINST.LINEAGE.1131 (TRACE_LINEAGE), EV.ALLINST.COMPONENT.1131 (OBSERVED_DERIVED), EV.ANOMSEG.1131 (OBSERVED_DERIVED)
...
**SUPPORT:** EV.CHAIN.1131 (TRACE_LINEAGE), EV.REACTION.1131 (OBSERVED_DERIVED), EV.FRESH.1131 (OBSERVED_DERIVED), EV.ALLINST.LINEAGE.1131 (TRACE_LINEAGE)

**CHALLENGES:** EV.CONTROL.EPISODE.1131
...
**CHALLENGES:** EV.FUNC.1131, EV.FRESH.1131, EV.POSTGAP.1131, EV.NODEADLINE.1131, EV.PHASE.1131, EV.LATEANOM.ORDER.1131, EV.LATEANOM.PRIORPLAN.1131, EV.LATEANOM.PHYSSTATE.1131, EV.LATEANOM.COUNTERFACTUAL.1131
...
**WHY NOT STRONGER:** The three selected spikes occur after t_phys; a STOP/fallback plan predates them. Their attributable collision effect is not identifiable without replay and payload/apply evidence.

**ALLOWED LANGUAGE:** The three late anomalies degraded refresh integrity, but removing only them is not observationally shown to prevent the collision; the declared braking models indicate the vehicle was already outside the contact-stop envelope.
