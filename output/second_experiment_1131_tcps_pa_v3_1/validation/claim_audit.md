...
**WHY NOT STRONGER:** No independent braking envelope or pre-t1 locked safety policy.

**ALLOWED LANGUAGE:** Primary tau_req is unavailable for this run.
...
**SUPPORT:** EV.REACTION.1131 (OBSERVED_DERIVED), EV.NODEADLINE.1131 (MISSING)
...
**WHY NOT STRONGER:** T_R is observed, but tau_req is not qualified.

**ALLOWED LANGUAGE:** Observed contract status is not testable for this run.
