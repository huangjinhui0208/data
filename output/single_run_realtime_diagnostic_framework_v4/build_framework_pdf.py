#!/usr/bin/env python3
"""Render the TCPS-PA v4.0 Markdown source directly to a Chinese-safe PDF.
    ...
    def draw_page(self, canvas, doc):
        ...
        if doc.page > 1:
            ...
            canvas.drawString(self.leftMargin, letter[1] - 0.39 * inch,
                              "TCPS-PA v4.0  ·  单次运行通用实时性—物理安全双向诊断框架")
...
def cover(styles) -> list:
    return [
        Spacer(1, 1.15 * inch),
        Paragraph('<font color="#2E74B5"><b>METHOD REFERENCE · TCPS-PA v4.0</b></font>',
        ...
        Paragraph("Event + Loop · R/A/G/C/L · Dual Contracts · Bidirectional Diagnosis",
