#!/usr/bin/env python3
"""Render the reviewed TCPS-PA v4.0 Markdown framework into a polished DOCX.
...
def configure_document(doc):
    ...
    p.paragraph_format.space_after = Pt(2)
    p.alignment = WD_ALIGN_PARAGRAPH.LEFT
    run = p.add_run("TCPS-PA v4.0  ·  单次运行通用实时性—物理安全双向诊断框架")
...
def add_cover(doc):
    ...
    r = kicker.add_run("METHOD REFERENCE  ·  TCPS-PA v4.0")
    ...
    r = subtitle.add_run("Event + Loop · R/A/G/C/L · Dual Contracts · Bidirectional Diagnosis")
